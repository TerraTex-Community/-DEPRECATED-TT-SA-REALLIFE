	...
	for theKey,thePlayer in ipairs(players) do
		if(vioGetElementData(thePlayer,"playtime"))then
			if((vioGetElementData(thePlayer,"playtime")/60)<25)then
				...
				outputChatBox("Besuche auch unser Forum: www.tt-rl.de",thePlayer,255,255,0)
				outputChatBox("Komm doch ebenfals auf unseren Teamspeak3 vorbei: 176.9.79.175:9987",thePlayer,255,255,0)		
			end	
